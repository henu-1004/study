 ...
 * 날짜 : 2025.07.14
 * 이름 : 서현우
 * 내용 : java static 변수(클래스변수) , static 메서드(클래스 메서드) 실습하기
 * 
 * 클래스변수(정적변수), 클래스메서드(정적메서드)
 * - static으로 선언한 변수와 메서드
 * - Method Area 영역에 따로 관리 됨
 * - new 객체 생성없이 바로 클래스타입으로 참조
 * - 객체(인스턴스) 간의 데이터 공유 목적으로 활용
 */

class Increment{
	private int num1=0;
	public static int num2=0;//클래스변수(static, 정적 변수)
...
public class StaticTest {
	...
	public static void main(String[] args) {
		 ...
		 * - 외부 생성을 막기 위해 private생성자 선언 
		 */
		
		
		
		//여러개의 객체를 생성할 필요가 없는 객체
		//Calc cal = new Calc();
