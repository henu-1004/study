...
public class RegularExpressionTest {
	...
	public static void main(String[] args) {
		...
		// 정규표현식 기본
		String pattern = "a[a-z]*"; //a로 시작하면서 그다음은 a-z까지, 개수는 0~n개, 아래 애플과 바나나로 예시체크
		boolean rs1 = Pattern.matches(pattern, "apple");
		boolean rs2 = Pattern.matches(pattern, "banana");
		
		System.out.println("rs1 : " + rs1);//apple는 pattern에 맞다.
		System.out.println("rs2 : " + rs2);//banana는 pattern에 맞지않다.
