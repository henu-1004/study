...
INSERT INTO "User" VALUES('user3', '강춘추', '1989-05-30', 'M', '010-1103-1989', NULL,               4320, 2, '서울', TO_DATE('2022-01-10 10:50:12', 'YYYY-MM-DD HH24:MI:SS'));
...
INSERT INTO "User" VALUES('user6', '선덕여왕','1979-07-28', 'F', '010-3101-1979', 'gueen@naver.com', 15840, 2, '대전', TO_DATE('2022-01-10 10:50:12', 'YYYY-MM-DD HH24:MI:SS'));
...
INSERT INTO Point (userId, point, "desc", pointDate)
VALUES ('user1', 1000, '회원가입 1000 적립', TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Point (userId, point, "desc", pointDate)
VALUES ('user1', 6000, '상품구매 5% 적립', TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Point (userId, point, "desc", pointDate)
VALUES ('user3', 2820, '상품구매 5% 적립', TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Point (userId, point, "desc", pointDate)
VALUES ('user7', 3610, '상품구매 5% 적립', TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Point (userId, point, "desc", pointDate)
VALUES ('user5', 3000, '이벤트 응모 3000 적립', TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Point (userId, point, "desc", pointDate)
VALUES ('user2', 1000, '회원가입 1000 적립', TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Point (userId, point, "desc", pointDate)
VALUES ('user2', 2000, '이벤트 응모 2000 적립', TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Point (userId, point, "desc", pointDate)
VALUES ('user2', 2650, '상품구매 5% 적립', TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Point (userId, point, "desc", pointDate)
VALUES ('user3', 1500, '이벤트 응모 1500 적립', TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Point (userId, point, "desc", pointDate)
VALUES ('user6', 15840, '상품구매 2% 적립', TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));
...
INSERT INTO Product (prodNo, cateNo, sellerNo, prodName, prodStock, prodPrice, prodSold, prodDiscount)
VALUES (141001, 14, 10001, '라떼 2인 소파/방수 패브릭', NULL, 320000, 42, 0);
...
VALUES ('22010210001', 'user2', 52300, '서울시 마포구 121', 1, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Orders (orderNo, userId, orderTotalPrice, orderAddress, orderStatus, orderDate)
VALUES ('22010210002', 'user3', 56700, '서울시 강남구 21-1', 1, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Orders (orderNo, userId, orderTotalPrice, orderAddress, orderStatus, orderDate)
VALUES ('22010210010', 'user4', 72200, '서울시 강서구 큰대로 38', 2, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Orders (orderNo, userId, orderTotalPrice, orderAddress, orderStatus, orderDate)
VALUES ('22010310001', 'user5', 127000, '경기도 광주시 초월로 21', 1, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Orders (orderNo, userId, orderTotalPrice, orderAddress, orderStatus, orderDate)
VALUES ('22010310100', 'user1', 120000, '경기도 수원시 120번지', 0, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Orders (orderNo, userId, orderTotalPrice, orderAddress, orderStatus, orderDate)
VALUES ('22010410101', 'user6', 792000, '부산시 남구 21-1', 2, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Orders (orderNo, userId, orderTotalPrice, orderAddress, orderStatus, orderDate)
VALUES ('22010510021', 'user7', 92200, '부산시 부산진구 56 10층', 4, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Orders (orderNo, userId, orderTotalPrice, orderAddress, orderStatus, orderDate)
VALUES ('22010510027', 'user8', 112000, '대구시 팔달로 19', 3, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Orders (orderNo, userId, orderTotalPrice, orderAddress, orderStatus, orderDate)
VALUES ('22010510031', 'user10', 792000, '대전시 한밭로 24-1', 2, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Orders (orderNo, userId, orderTotalPrice, orderAddress, orderStatus, orderDate)
VALUES ('22010710110', 'user9', 94500, '광주시 충열로 11', 1, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));
...
VALUES ('user1', 100101, 1, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Cart (userId, prodNo, cartProdCount, cartProdDate)
VALUES ('user1', 100110, 2, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Cart (userId, prodNo, cartProdCount, cartProdDate)
VALUES ('user3', 120103, 1, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Cart (userId, prodNo, cartProdCount, cartProdDate)
VALUES ('user4', 130112, 1, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Cart (userId, prodNo, cartProdCount, cartProdDate)
VALUES ('user5', 130101, 1, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Cart (userId, prodNo, cartProdCount, cartProdDate)
VALUES ('user2', 110101, 3, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Cart (userId, prodNo, cartProdCount, cartProdDate)
VALUES ('user2', 160103, 1, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Cart (userId, prodNo, cartProdCount, cartProdDate)
VALUES ('user2', 170115, 1, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Cart (userId, prodNo, cartProdCount, cartProdDate)
VALUES ('user3', 110101, 1, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));

INSERT INTO Cart (userId, prodNo, cartProdCount, cartProdDate)
VALUES ('user6', 130101, 1, TO_DATE('2022-01-10 10:50:12','YYYY-MM-DD HH24:MI:SS'));
...
--문제1
select u.userId, p.prodname, c.cartprodcount
...
from product p join category c on c.cateno = p.cateno
join seller s on s.sellerno=p.sellerno;


--문제3
select u.userid, u.name, u.hp, u.point, nvl(sum(p.point),0) as 적립포인트_총합
...
SELECT
  ...
  u.name,
  u.hp,
  u.point                                  AS 저장된_현재포인트,      -- DB에 저장된 값
  NVL(SUM(p.point), 0)                     AS 적립포인트_총합,        -- 적립내역 합계
  (u.point + NVL(SUM(p.point), 0))         AS 계산_현재포인트         -- 초기값 + 적립합계
FROM "User" u
LEFT JOIN Point p
