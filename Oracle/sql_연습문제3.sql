...
create table customer(
    C_ID char(14) NOT NULL PRIMARY KEY,
    C_NAME CHAR(20) NOT NULL,
    C_TYPE NUMBER(1) NOT NULL,
    C_HP CHAR(14) NOT NULL UNIQUE,
    C_ADDR CHAR(100) DEFAULT NULL
);
...
--3-15
SELECT SUM(TR_AMOUNT) AS "큰 금액", AVG(TR_AMOUNT)
FROM TRANSACTION
WHERE TR_TYPE=1;
...
SELECT
    ...
    COUNT(CASE WHEN TR_TYPE = 2 THEN 1 END) AS "출급 건수"
FROM TRANSACTION;
